...
const InfoButton = ({ infoText, small }) => {
    ...
    return (
        <div className={`relative text-center`} onMouseOver={infoButtonMouseOver} onMouseLeave={infoButtonMouseLeave}>
            ...
            <div className={`w-[500px] z-10 ${infoBoxIsActive ? 'flex' : 'hidden'} flex-col items-center gap-8 rounded-xl bg-black text-white shadow-md text-lg py-6 px-8 fixed lg:absolute max-w-[90vw] lg:max-w-none left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300`}>
