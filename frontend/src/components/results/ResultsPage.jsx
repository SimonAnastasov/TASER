...
const ResultsPage = () => {
    ...
    // TODO: add checks if analysisResult is null

    return (
        <div className="px-6 lg:px-0">
            {analysisResult ? (
                <>
                    <div className="heading--3 text-center flex justify-center items-center gap-4">
                        Global Analysis
                        <InfoButton infoText={INFO_BOXES_ARE_SCROLLABLE}/>
                    </div>
                    ...
                    <div className="lg:px-6 mx-auto mt-8 grid grid-cols-1 lg:grid-cols-3 gap-y-8 lg:gap-8">
                        ...
                        <div className="relative bg-black/80 text-white shadow-md max-h-[400px] lg:max-h-[832px] overflow-y-scroll">
                            ...
                            <div className="py-2 px-4">
                                ...
                                {Object.entries(analysisResult.Global_entities_list).map(([entity_type, entities]) => (
